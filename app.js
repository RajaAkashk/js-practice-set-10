...
function warnUser(userName){
  console.log("Hey, "+userName+"! You are running out of storage.")
}
warnUser("Sam");
...
function showTertiaryColors (color1,color2,color3,color4,color5,color6){
  return "Six Tertiary Colors: "+color1+"-"+color2+","+color3+"-"+color2+","+color3+"-"+color4+","+color3+"-"+color4+","+color5+"-"+color6+","+color1+"-"+color6;
}
...
console.log(decrementAgeBy10(15));
...
function calculateTotalPrice(price,quality){
